...
class TabsFragment : BaseFragment(), FabHandler {
  private val tabsRecyclerView: RecyclerView by lazy { view!!.findViewById(R.id.tabsRecyclerView) }
  ...
  private val fragmentTabsRoot: ViewGroup by lazy { view!!.findViewById(R.id.fragmentTabsRoot) }
  ...
  override fun onActivityCreated(savedInstanceState: Bundle?) {
    ...
    tabsViewModel = ViewModelProvider(this, viewModelFactory).get(TabsViewModel::class.java)
    observeViewModel()
  }
