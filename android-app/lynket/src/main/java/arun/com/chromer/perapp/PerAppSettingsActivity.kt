...
class PerAppSettingsActivity : BaseActivity(), CompoundButton.OnCheckedChangeListener, Snackable {
  ...
  private val appRecyclerView: RecyclerView by lazy { findViewById(R.id.appRecyclerView) }
  private val swipeRefreshLayout: androidx.swiperefreshlayout.widget.SwipeRefreshLayout by lazy { findViewById(R.id.swipeRefreshLayout) }
  ...
  private fun observeViewModel() {
    ...
    perAppViewModel =
      ViewModelProvider(owner, viewModelFactory).get(PerAppSettingsViewModel::class.java)
