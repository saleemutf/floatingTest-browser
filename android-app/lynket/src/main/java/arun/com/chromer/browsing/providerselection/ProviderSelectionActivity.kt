...
class ProviderSelectionActivity : BaseActivity() {
  ...
  private val providerRecyclerView: RecyclerView by lazy { findViewById(R.id.providerRecyclerView) }
  private val webViewImg: ImageView by lazy { findViewById(R.id.webViewImg) }
  private val webViewNotRecommended: TextView by lazy { findViewById(R.id.webViewNotRecommended) }
  ...
  private fun observeViewModel(savedInstanceState: Bundle?) {
    providerSelectionViewModel = ViewModelProvider(this, viewModelFactory)
