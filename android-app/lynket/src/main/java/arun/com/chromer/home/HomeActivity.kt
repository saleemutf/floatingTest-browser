...
class HomeActivity : BaseActivity(), Snackable, UsesViewModel {
  private val coordinatorLayout: View by lazy { findViewById(R.id.coordinatorLayout) }
  private val tipsIcon: ImageView by lazy { findViewById(R.id.tipsIcon) }
  private val settingsIcon: View by lazy { findViewById(R.id.settingsIcon) }
  private val homeFeedRecyclerView: com.airbnb.android.epoxy.EpoxyRecyclerView by lazy { findViewById(R.id.homeFeedRecyclerView) }
  private val searchBar: View by lazy { findViewById(R.id.searchBar) }
  private val searchIcon: View by lazy { findViewById(R.id.searchIcon) }
  private val searchHint: TextView by lazy { findViewById(R.id.searchHint) }

  private val materialSearchView: arun.com.chromer.search.view.MaterialSearchView by lazy { findViewById(R.id.materialSearchView) }
  private val shadowView: View by lazy { findViewById(R.id.shadowView) }
