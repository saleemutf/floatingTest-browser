...
class HistoryFragment : BaseFragment(), Snackable, FabHandler {
  private val swipeRefreshLayout: androidx.swiperefreshlayout.widget.SwipeRefreshLayout by lazy { view!!.findViewById(R.id.swipeRefreshLayout) }
  private val historyCard: View by lazy { view!!.findViewById(R.id.historyCard) }
  private val historySwitch: SwitchCompat by lazy { view!!.findViewById(R.id.historySwitch) }
  private val enableHistorySubtitle: TextView by lazy { view!!.findViewById(R.id.enableHistorySubtitle) }
  private val historyIcon: ImageView by lazy { view!!.findViewById(R.id.historyIcon) }
  private val fullIncognitoIcon: ImageView by lazy { view!!.findViewById(R.id.fullIncognitoIcon) }
  private val fullIncognitoModeCard: View by lazy { view!!.findViewById(R.id.fullIncognitoModeCard) }
  private val fullIncognitoModeSwitch: SwitchCompat by lazy { view!!.findViewById(R.id.fullIncognitoModeSwitch) }
  private val historyList: RecyclerView by lazy { view!!.findViewById(R.id.historyList) }
  private val error: TextView by lazy { view!!.findViewById(R.id.error) }
