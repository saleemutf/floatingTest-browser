...
class HomeFragment : BaseFragment(), Snackable {
  private val recent_missing_text: TextView by lazy { view!!.findViewById(R.id.recent_missing_text) }
  private val recentsHeaderIcon: ImageView by lazy { view!!.findViewById(R.id.recentsHeaderIcon) }
  private val recentsList: RecyclerView by lazy { view!!.findViewById(R.id.recentsList) }
  private val providerDescription: TextView by lazy { view!!.findViewById(R.id.providerDescription) }
  private val providerIcon: ImageView by lazy { view!!.findViewById(R.id.providerIcon) }
  private val providerReason: TextView by lazy { view!!.findViewById(R.id.providerReason) }
  private val providerChangeButton: View by lazy { view!!.findViewById(R.id.providerChangeButton) }
  private val tipsIcon: ImageView by lazy { view!!.findViewById(R.id.tipsIcon) }
  private val tipsButton: View by lazy { view!!.findViewById(R.id.tipsButton) }
