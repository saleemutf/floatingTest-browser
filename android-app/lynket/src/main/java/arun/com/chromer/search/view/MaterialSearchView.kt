...
constructor(
  ...
  private val msvEditText: EditText by lazy { findViewById(R.id.msvEditText) }
  private val msvLeftIcon: ImageView by lazy { findViewById(R.id.msvLeftIcon) }
  private val msvClearIcon: ImageView by lazy { findViewById(R.id.msvClearIcon) }
  private val msvVoiceIcon: ImageView by lazy { findViewById(R.id.msvVoiceIcon) }
  private val searchSuggestions: com.airbnb.android.epoxy.EpoxyRecyclerView by lazy { findViewById(R.id.searchSuggestions) }
